...
for (let i = 0; i < coursesAndDurationArray.length; i++) {
    ...
    div.innerText = `Title: ${title}, Duration: ${monthDuration} months`;
...
for (let i = 0; i < coursesAndDurationArray.length; i++) {
    ...
    heading.innerText = coursesAndDurationArray[i].title;
    let paragraph = document.createElement('p');
    paragraph.classList.add('description');
    paragraph.innerText = `Duration: ${coursesAndDurationArray[i].monthDuration} months`;
...
for (let i = 0; i < simpsons.length; i++) {
    ...
    nameElement.innerText = `${simpsons[i].name} ${simpsons[i].surname}`;
    divElement.appendChild(nameElement);
    let imageElement = document.createElement('img');
    imageElement.src = simpsons[i].photo;
    divElement.appendChild(imageElement);
    let ageElement = document.createElement('p');
    ageElement.innerText = `Age: ${simpsons[i].age}`;
    divElement.appendChild(ageElement);
    let infoElement = document.createElement('p');
    infoElement.innerText = simpsons[i].info;
...
for (let i = 0; i < coursesArray.length; i++) {
    ...
    titleDiv.innerText = `Title: ${coursesArray[i].title}`;
    courseDiv.appendChild(titleDiv);
    let monthDurationDiv = document.createElement('div');
    monthDurationDiv.innerText = `Duration: ${coursesArray[i].monthDuration} months`;
    courseDiv.appendChild(monthDurationDiv);
    let hourDurationDiv = document.createElement('div');
    hourDurationDiv.innerText = `Hours: ${coursesArray[i].hourDuration}`;
    courseDiv.appendChild(hourDurationDiv);
    let modulesDiv = document.createElement('div');
    let modulesList = document.createElement('ul');
    coursesArray[i].modules.forEach(module => {
    ...
    arrayWrapper.appendChild(courseDiv);
}
document.body.appendChild(arrayWrapper);